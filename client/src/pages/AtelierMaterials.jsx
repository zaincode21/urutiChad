        ...
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 flex items-center">
                        <Scissors className="h-8 w-8 mr-3 text-blue-600" />
                        {tSync('Atelier Inventory')}
                    </h1>
                    <p className="text-gray-600 mt-2">{tSync('Manage your fabrics, accessories, and supplies')}</p>
                </div>
                <button
                    onClick={() => setShowAddModal(true)}
                    className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 hover:shadow-lg"
                >
                        ...
                        {materialCategories.map(category => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`py-2 px-1 border-b-2 font-medium text-sm flex items-center gap-2 ${selectedCategory === category.id
            ...
            <div className="bg-white rounded-lg shadow">
                ...
                {loading ? (
                    ...
                    <div className="p-8 text-center">
                        ...
                        <h3 className="text-lg font-medium text-gray-900 mb-2"><TranslatedText text="No Materials Found" /></h3>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl">
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h2 className="text-xl font-bold text-gray-900">{tSync('Add New Material')}</h2>
                            <button
            ...
            {editingMaterial && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl">
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h2 className="text-xl font-bold text-gray-900">{tSync('Edit Material')}</h2>
                            <button
